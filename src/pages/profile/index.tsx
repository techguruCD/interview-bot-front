...
import { BsArrowUpRight, BsClipboardCheck, BsFillPatchExclamationFill, BsFillSendFill } from "react-icons/bs";
          ...
          <div className="">
            ...
            flex flex-col rounded-md cursor-pointer"
             ...
             md:flex md:justify-normal gap-2"
                        >
                          <div>
                            <Image src={formData ? formData?.photo : "/images/placeholder.jpg"} alt="User profile" height={120} width={120} />
                          </div>
                          <div className="flex md:block mb-4 md:mb-0 ">
                            <div className="mr-2">
                              <p className="text-sm capitalize">{formData?.name}</p>
                              <p className="text-sm capitalize">{formData?.headline}</p>
                            </div>
                        ...
                        <div className=" h-[60%] flex md:shadow-md mt-4 md:mt-0 justify-center">
                          {showModal && (
                            <EditPublicProfileModal setShowModal={setShowModal} formData={formData} />
                          )}
                          <button
                        ...
                        <div className="">
                          ...
                          <div className=" p-6 flex gap-2">
                            ...
                            <p className="border-[1px] border-gray-400 p-4">
                              Hi i am {formData?.name}&apos;s interview bot, ask me anything about {formData?.name}&apos;s work experience
                            </p>
                          </div>
                          <div className="lg:flex lg:justify-end">
                            <div className="flex ">
                              ...
                              >
                                <p className="text-right break-words">{message}</p>
                              </div>
                            </div>
                          </div>
                            ...
                            <div className=" w-[70%] md:w-[60%] ">
                              <div className=" p-4">
                                ...
                                <div className="border-[1px] p-2 md:p-4 gap-2 md:gap-0 rounded-md border-gray-400 flex justify-between">
                                  ...
                                  />
                                  <div className="flex p-1 gap-1">
                                    <FaMicrophone onClick={handleMicrophoneClick} style={{ cursor: 'pointer' }} />
                                    <BsFillSendFill onClick={handleSend} style={{ cursor: 'pointer' }} />
                                  </div>
                                </div>
                              </div>
                              <div className="flex justify-center">
